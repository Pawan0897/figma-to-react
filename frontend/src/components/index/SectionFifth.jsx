                                ...
                                <div className="card p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-20">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 0 ? 'h4_color' : ''}`}>
                                                Custom Development<br></br> Service
                                            </h5>
                                            <p className={` ${hovered === 1 ? "text-gray-300" : ""}`}>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
                                        </div>
                                        {/* ************* */}
                            ...
                            <div className="section_fifth_card">
                                ...
                                <div className="card  p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-10">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 1 ? 'h4_color' : ''}`}>
                        ...
                        <div className="col-md-4 p-3 md-pb">
                            <div className="section_fifth_card">
                                ...
                                <div className="card p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-10">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 2 ? 'h4_color' : ''}`}>
                        ...
                        <div className="col-md-4 p-3 md-pb">
                            <div className="section_fifth_card">
                                ...
                                <div className="card p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-10">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 3 ? 'h4_color' : ''}`}>
                        ...
                        <div className="col-md-4 p-3 md-pb">
                            <div className="section_fifth_card">
                                ...
                                <div className="card p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-10">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 4 ? 'h4_color' : ''}`}>
                        ...
                        <div className="col-md-4 p-3 md-pb">
                            <div className="section_fifth_card">
                                ...
                                <div className="card p-4 position-relative"
                                    ...
                                    <div className="section_fifth_title mt-6 z-10">
                                        <div className="content">
                                            <h5 className={`font-semibold ${hovered === 5 ? 'h4_color' : ''}`}>
